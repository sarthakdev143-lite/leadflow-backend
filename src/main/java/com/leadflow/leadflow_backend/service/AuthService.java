...
import com.leadflow.leadflow_backend.exception.ConflictException;
import com.leadflow.leadflow_backend.exception.ValidationException;
...
public class AuthService {
    ...
    public Map<String, String> register(RegisterRequest request) {
        ...
        if (userRepository.existsByPhone(request.getPhone())) {
            throw new ConflictException("User", "phone", request.getPhone());
        }
        ...
        log.info("New admin registered successfully: {}", user.getEmail());
