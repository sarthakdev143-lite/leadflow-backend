...
```
java -Dspring.profiles.active=production -jar ./target/leadflow-backend-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=com.leadflow/leadflow-backend
```
